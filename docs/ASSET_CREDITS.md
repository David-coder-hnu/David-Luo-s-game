...
| `docs/evidence/runtime/v3_loop2_child_room.png` | V3 第二轮儿童房 Godot 实机证据 | 项目原创生成式 V3 资产；Godot 4.6.3 macOS Compatibility 渲染 | 同 V3 运行时资产 | 640×360；真实状态切换后的床边正面儿童画、移动交互点与第二轮 HUD | 2026-07-13 |
